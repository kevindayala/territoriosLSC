                ...
                <form method="GET" action="{{ route('cities.index') }}"
                    ...
                    <div class="hidden md:block flex-shrink-0">
                        <a href="{{ route('cities.create') }}"
                            ...
                            <span class="hidden md:inline">Registrar Ciudad</span>
                        </a>
                    </div>
                </form>
            </div>
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="flex items-center">
                                <div
                                    class="h-1.5 w-1.5 rounded-full me-1.5 {{ $city->is_active ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.4)]' : 'bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.4)]' }}">
                                </div>
                                <span
                                    class="text-[10px] font-black uppercase tracking-wider {{ $city->is_active ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                            ...
                            <tr
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span
                                        ...
                                        {{ $city->territories_count }}
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div
                                            class="h-2 w-2 rounded-full me-2 {{ $city->is_active ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.4)]' : 'bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.4)]' }}">
                                        </div>
                                        <span
                                            class="text-sm font-medium {{ $city->is_active ? 'text-green-700 dark:text-green-400' : 'text-red-700 dark:text-red-400' }}">
