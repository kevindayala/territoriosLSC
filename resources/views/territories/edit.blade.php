                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('territories.update', $territory) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code', $territory->code) }}"
                                required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="neighborhood_name" id="neighborhood_name"
                                value="{{ old('neighborhood_name', $territory->neighborhood_name) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status" required
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                <option value="active" {{ old('status', $territory->status) == 'active' ? 'selected' : '' }}>Activo</option>
                                <option value="inactive" {{ old('status', $territory->status) == 'inactive' ? 'selected' : '' }}>Inactivo</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('notes', $territory->notes) }}</textarea>
                    ...
                    <div class="mt-8 border-t pt-6" x-data>
                        <form id="delete-territory-form" action="{{ route('territories.destroy', $territory) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                        ...
                        <x-modal-confirm name="confirm-delete" title="Eliminar Territorio"
                            ...
                            <x-slot name="footer">
                                ...
                                <x-danger-button class="ml-3"
                                    x-on:click="document.getElementById('delete-territory-form').submit()">
                                    Sí, eliminar
                                </x-danger-button>
                            </x-slot>
                        </x-modal-confirm>
