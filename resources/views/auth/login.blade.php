    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative mt-1 group">
                <x-text-input id="password" class="block w-full pe-12 transition-all"
                    ::type="show ? 'text' : 'password'" name="password" required autocomplete="current-password" />

                <button type="button" @click="show = !show"
                    class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-400 hover:text-blue-500 transition-colors duration-200 focus:outline-none"
                    tabindex="-1">
